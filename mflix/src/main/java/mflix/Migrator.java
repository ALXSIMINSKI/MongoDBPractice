...
public class Migrator {
    ...
    private static UpdateOneModel<Document> transformRating(Document doc) {
        try {
            ...
            Bson findDoc = Filters.eq("_id", doc.getObjectId("_id"));
            Bson intValue = Updates.set("imdb.rating", rating);
            return new UpdateOneModel<Document>(findDoc, intValue);
    ...
    public static void main(String[] args) {
        ...
        String mongoUri = "mongodb+srv://dbAmper:dbAmper@mflix.4pfpp.mongodb.net/test";
        ...
        // format pattern
        dateStringFilter = Filters.and(Filters.exists("lastupdated"), Filters.type("lastupdated", "string"));
